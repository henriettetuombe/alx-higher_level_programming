...
* **5. Print string**
  * [5-print_string.py](./5-print_string.py): Python script that prints a string stored
  ...
  contained in `str`, followed by another number

* **6. Play with strings**
  * [6-concat.py](./6-concat.py): Python script that prints `Welcome to ALX
  School!` using the variables `str1 = "ALX"` and `str2 = "School"`.
